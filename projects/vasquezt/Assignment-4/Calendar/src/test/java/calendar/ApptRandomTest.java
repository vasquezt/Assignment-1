					...
					String methodName = ApptRandomTest.RandomSelectMethod(random);
					   if (methodName.equals("setTitle")){
						   ...
						   appt.setValid();
							...
							int altstartDay=ValuesGenerator.getRandomIntBetween(random, 1, 11);
							int altstartMonth=ValuesGenerator.getRandomIntBetween(random, 1, 11);
							int altstartYear=ValuesGenerator.getRandomIntBetween(random, 2018, 2018);
							appt.isOn(altstartDay, altstartMonth, altstartYear);
					   }
				}
